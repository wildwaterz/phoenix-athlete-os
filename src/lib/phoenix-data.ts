...
export interface PhoenixState {
  ...
  todayQuests: { id: string; label: string; done: boolean; xp: number }[];
...
const seedQuests = [
  { id: "q1", label: "Morning check-in", done: true, xp: 10 },
  { id: "q2", label: "Quad activation set ×3", done: true, xp: 15 },
  { id: "q3", label: "Heel-prop extension 10 min", done: false, xp: 20 },
  { id: "q4", label: "Protein target hit", done: false, xp: 10 },
  { id: "q5", label: "Evening check-in", done: false, xp: 10 },
];
...
const initial: PhoenixState = {
  ...
  evening: null,
  history: { morning: [], evening: [] },
  milestones: seedMilestones,
  journal: seedJournal,
  todayQuests: seedQuests,
  todayRecommendation:
    "Hold yesterday's volume. Add 3 sets of terminal knee extension holds. Re-test extension in 48h.",
};
